...
/**
 * Servlet implementation class StoreModule
 */
public class StoreModule extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			while (rowIterator.hasNext()) {
				...
				st.executeUpdate("insert into ModuleDetail(ModuleName,ProjectId,ModuleDescription,ModuleId) values('"
