		...
		if (session != null) {
			if (name != "" && li.size() != 0) {
				...
				for (int i = 0; i < li.size(); i++) {
					...
					exp += "<td>" + li.get(i).getDesignation() + "</td>";
					exp += "<td>" + li.get(i).getLevel() + "</td>";
					exp += "<td>" + li.get(i).getExpertise() + "</td>";
					exp += "<td>" + li.get(i).getClientId() + "</td>";
					exp += "<td>" + li.get(i).getEmail() + "</td>";
					exp += "<td>" + li.get(i).getTeamId() + "</td>";
					exp += "<td>" + li.get(i).getProfCamps() + "</td>";
					exp += "<td>" + li.get(i).getProfProject() + "</td>";
					exp += "<td>" + li.get(i).getDateOfJoining() + "</td>";
					exp += "<td>" + li.get(i).getLastWorkingDay() + "</td>";
					exp += "<td>" + li.get(i).getBillable() + "</td>";
					exp += "<td>" + li.get(i).getActiveUser() + "</td>";
