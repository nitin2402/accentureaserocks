...
<%@ include file="common_left.jsp" %>
		...
		<div id="content_right">
			...
			<table>
			   ...
			   <tr> 
			   <td>START DATE :</td><td> <input type="text" id="calendar" name="startDate"  size="22" /></td></tr>
				<tr><td>END DATE :</td><td> <input type="text" id="calendar1" name="endDate"  size="22"/></td></tr>
				</table>
				<br/>
