				...
				<div>
					...
					<div style="font-size: 14px;">
						<form action="AddTeam" method="post">
							...
							<input type="submit" value="Submit" id="tconnect"
										name="tconnect" style="margin-left:80px"/>
									
							
							<br/><br/><br/>
							<span style="color: red"> <%=request.getParameter("msg") != null ? request
					.getParameter("msg") : ""%></span><br/>
						</form>

						<br /> <br /> <!-- <a href="editteam.jsp" style="font-weight: normal;margin-left:500px">Edit Team</a> -->
					</div>
